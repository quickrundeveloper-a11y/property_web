                ...
                <div className="p-4 pt-6">
                  ...
                  <div className="flex flex-wrap items-center justify-between text-gray-500 gap-2">
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-[10px]"><span className="font-bold text-gray-700">{property.bedrooms || property.beds || 0}</span> Beds</span>
                    </div>
                    <div className="flex items-center gap-1">
                      <Bath className="w-3.5 h-3.5 text-[#0066FF]" />
                      <span className="text-[10px]"><span className="font-bold text-gray-700">{property.bathrooms || property.baths || 0}</span> Baths</span>
                    </div>
                    <div className="flex items-center gap-1">
